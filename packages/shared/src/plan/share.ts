...
/**
 * What a share link reveals: the plan's structure. Results, grades, exam dates, recognitions and the target grade
 * stay private; grades are encrypted in the browser and never readable on the server anyway. Stripping happens on
 * the server before anything leaves it, and this function is the single definition.
 */
