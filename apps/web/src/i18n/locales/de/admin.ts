export const admin = {
  ...
  accounts: {
    ...
    columns: {
      ...
      plans: 'Pläne',
      links: 'Links',
      unlimitedChat: 'Assistent ohne Limit',
      admin: 'Admin',
      actions: 'Aktionen',
    },
    verified: 'bestätigt',
    ...
    unlimitedChatLabel: 'Assistent ohne Tageslimit für {{email}}',
    adminLabel: 'Adminrechte für {{email}}',
    adminAlwaysUnlimited: 'Admins nutzen den Assistenten immer ohne Tageslimit.',
    adminNeedsVerified: 'Erst möglich, wenn die E-Mail-Adresse bestätigt ist.',
    unlimitedChatGranted: '{{email}} kann den Assistenten jetzt ohne Tageslimit nutzen.',
    unlimitedChatRevoked: 'Für {{email}} gilt wieder das Tageslimit des Assistenten.',
    self: 'du',
  ...
  audit: {
    ...
    actions: {
      ...
      set_unlimited_chat: 'Assistent-Limit eines Kontos geändert',
